  ...
  useEffect(() => {
    const fetchdata = async () => {
      ...
      try {
        ...
        await axios
          .post(`${serverAPIURL}/api/getlistings`, { email: email })
          .then((response) => {
      ...
      >
        <View style={{ borderRadius: 20, overflow: "hidden", flex: 1 }}>
          <TouchableOpacity
            ...
            android_ripple={{ color: "#000f9f" }}
            onPress={buyPage}
          >
            <Text style={styles.boldtext}>BUY</Text>
            <Text style={styles.lighttext}>
              Buy Scrap From Over 15+ Different Categories
            </Text>
        ...
        <View style={{ borderRadius: 20, overflow: "hidden", flex: 1 }}>
          ...
          >
            ...
            <Text style={styles.lighttext}>
              Sell Scrap To People Nearby You For The Best Price
            </Text>
            <Image source={rightArrow} style={styles.rightArrow}></Image>
          </TouchableOpacity>
        </View>
          ...
          <View style={styles.itemsContainer}>
            {listings.length === 0 ? (
              <Text
                style={[
                  styles.lighttext,
                  { textAlign: "center", marginTop: 20, alignSelf: "center" },
                ]}
              >
                No listings yet
              </Text>
              ...
              listings.map((item, index) => (
                <View key={index} style={{ flex: 1 }}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      navigation.navigate("selleritem", {
                        item: item,
                      });
                    }}
                  >
                    ...
                    <View style={styles.itemscurveboxTEXTBOX}>
                      <Text
                        style={[styles.boldtext, { fontSize: 25, opacity: 1 }]}
                      >
                        {item.name.length > 14
                    ...
                    >
                      <Image
                        source={rightArrow}
                        style={[styles.rightArrow, { height: 20, width: 40 }]}
                      />
                    </View>
                  </TouchableOpacity>
                </View>
